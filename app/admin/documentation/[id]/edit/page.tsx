...
export default function EditDocumentationPage() {
  ...
  const id = params.id; // Ngambil ID dari URL
      ...
      try {
        ...
        if (result.success) {
          ...
          setFormData({
            ...
            date: data.date, // Format date dari database Laravel biasanya YYYY-MM-DD
  ...
  // Handlers untuk Drag & Drop Gambar
  ...
  const handleFile = (file: File) => {
    if (file.type.startsWith("image/")) {
      ...
      setImageFile(file); // Simpan file baru jika user ganti gambar
    } else {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Hanya kirim gambar kalau user milih gambar baru
    if (imageFile) {
    ...
    try {
      ...
      if (response.ok) {
        alert("Yeay! Dokumentasi berhasil diupdate!");
        router.push("/admin/documentation");
      } else {
    ...
    <div className="space-y-8 animate-fade-in-up pb-10 max-w-5xl mx-auto">
      ...
      <div>
        ...
        <p className="text-gray-500 font-medium">
          Perbarui informasi atau ganti foto untuk dokumentasi ini.
        </p>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-5">
              ...
              <p className="text-[11px] text-gray-500 mt-2 text-center">
                *Biarkan jika tidak ingin mengganti foto
              </p>
            </div>
